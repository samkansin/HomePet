...
const BlogPostCard = (props) => {
    return (
        <div className="card-container">
            <img alt={props.image_alt} src={props.image_src} className="card-image" />
            <div className="card-body">
                <div className="card-age-gender-status">
                    <span className="age-gender">{props.ageGender}</span>
                    {
                        props.status === 'Adopted' ? <span className="status adopted">{props.status}</span> : <span className="status">{props.status}</span>
                    }
                </div>
